    ...
    stages {
        ...
        stage('LOGGING THROUGH SERVICE PRINCIPLE') {
            steps {
                   ...
                   pwsh '''az login --service-principal -u http://azure-cli-2021-05-05-12-30-43 -p Xya883tIF0qTnF5lqXR.h2gHU_s30OzjiJ --tenant f01c76b3-0b0f-4eaa-a505-cc0734405255
'''
        ...
        stage('creating rg group'){
            steps{
            pwsh'az group create -l westus -n fromjenkins1'
            }
    }
    }}
